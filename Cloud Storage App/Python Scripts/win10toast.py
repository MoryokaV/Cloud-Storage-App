...
class ToastNotifier(object):
    ...
    def _show_toast(self, title, msg,
        ...
        self.wc.lpszClassName = str("Taskbar")  # must be a string
        ...
        if icon_path is not None:
            icon_path = os.path.join(os.path.abspath(os.getcwd())+ "\\Python Scripts\\" ,icon_path)
        ...
        nid = (self.hwnd, 0, flags, WM_USER + 20, hicon, "Cloud Storage App")
        Shell_NotifyIcon(NIM_ADD, nid)
        Shell_NotifyIcon(NIM_MODIFY, (self.hwnd, 0, NIF_INFO,
                                      WM_USER + 20,
                                      hicon, "Cloud Storage App Tooltip", msg, 200,
                                      title))
